  ...
  Alpine.addMagicProperty('fetch', function ($el) {
    return function () {
      ...
      if (typeof parameters[0] === 'string' && parameters[0].length) {
        return axios__WEBPACK_IMPORTED_MODULE_0___default()(parameters[0]).then(function (response) {
          return response.hasOwnProperty('data') ? response.data : response;
        });
      }

      if (_typeof(parameters[0]) === 'object') {
        return axios__WEBPACK_IMPORTED_MODULE_0___default()(parameters[0]);
      }
...
/* harmony default export */ __webpack_exports__["default"] = (registerFetchMagicMethod);
